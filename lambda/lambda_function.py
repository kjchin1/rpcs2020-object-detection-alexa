...
class GetMissingObjectHandler(AbstractRequestHandler):
    """Handler for Skill Launch and GetMissingObject Intent."""

    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return (is_request_type("LaunchRequest")(handler_input) or
                is_intent_name("GetMissingObjectIntent")(handler_input))

    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        logger.info("In GetMissingObjectHandler")

        # request to find out what object is missing
